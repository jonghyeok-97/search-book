...
class BookServiceTest {
    ...
    void search_인자가_그대로_repository에_전달된다() {
        ...
        bookService.search("HTTP", 1, 10, SortType.DATE);

        then(naverBookRepository).should().search("HTTP", 1, 10, SortType.DATE);
    }
    ...
    void 책을_검색한다() {
        ...
        Page<Book> search = bookService.search("HTTP", 1, 10, SortType.DATE);
